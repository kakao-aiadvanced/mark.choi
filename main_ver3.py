...
def web_search(state):
    ...
    if "generation" in state:
        documents.append(Document(page_content="INFINITE LOOP"))
    ...
    if grade == "yes":
        ...
        if grade == "yes":
            ...
            for doc in documents:
                if "INFINITE LOOP" in doc.page_content:
                    print("---DECISION: END INFINTE LOOP---")
                    return "infinite"
...
# Test
# inputs = {"question": "What is prompt? find in the document without web search"}
# inputs = {"question": "What is prompt? find in the web"}
# inputs = {"question": "What is prompt? find in the document with web search"} # web search infinite loop
inputs = {"question": "Who is messi?"}
